...
/// Servicio para gestionar productos con la API
class ProductService extends ChangeNotifier {
  ...
  /// Constructor que inicia la carga de productos
  ProductService() {
    loadProducts();
  }
  ...
  /// Determina si debe crear o actualizar un producto basado en su ID
  ...
  /// Elimina un producto de la API y actualiza la lista local
  ...
  /// Añade un producto a la lista local
